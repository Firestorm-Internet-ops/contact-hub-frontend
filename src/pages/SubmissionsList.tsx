...
const SubmissionsList = () => {
    ...
    // Listen for sync events to refresh submission list
    useEffect(() => {
        const handleSync = () => {
            fetchData();
        };
        window.addEventListener('emails-synced', handleSync);
        return () => window.removeEventListener('emails-synced', handleSync);
    }, [siteId]);  // re-attach if siteId changes
